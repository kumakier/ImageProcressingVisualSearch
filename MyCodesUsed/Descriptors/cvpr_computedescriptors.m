...
OUT_FOLDER = 'C:/Users/Darren Smith/Desktop/SurreyUniversityProjects/1stSemster/ComputerVisionPatternRecognition/MatLabSessions/ComputerVisionProjectImprovement/ComputerVisionCoursework_6553517/cwork_DS_basecode_2018/descriptors';
%% and within that folder, create another folder to hold these descriptors
%% the idea is all your descriptors are in individual folders - within
%% the folder specified as 'OUT_FOLDER'.
% OUT_SUBFOLDER='globalRGBhisto';
%OUT_SUBFOLDER='ColorGrid';
OUT_SUBFOLDER='EOH';
...
%     F=ColourGridDescriptor(img);
%     F=MyHistogramDescriptor(img);
    F=Colour_Grid_EOH_Descripter(img);
    save(fout,'F');
    toc
end
